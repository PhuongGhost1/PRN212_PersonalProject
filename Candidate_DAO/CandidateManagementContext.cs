...
public partial class CandidateManagementContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        #warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
                => optionsBuilder.UseSqlServer("Server=LAPTOP-BDH0NE6H;Uid=sa;Pwd=12345;Database=CandidateManagement;TrustServerCertificate=True");
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CandidateId).HasName("PK__Candidat__DF539BFC0AFFB9CE");
        ...
        {
            entity.HasKey(e => e.Email).HasName("PK__HRAccoun__A9D10535033D57A2");
        ...
        {
            entity.HasKey(e => e.PostingId).HasName("PK__JobPosti__C31796A5E296BA8D");
